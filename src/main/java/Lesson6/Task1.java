...
public class Task1 {
    public static void main(String[] args) {
        Notebook ChuwiAH401 = new Notebook("LG", "A-704", "Black", 14.6, "LCD", 8, 256, "SSD");
        Notebook SamsungS101 = new Notebook("ASUS", "K-302", "White", 17.6, "LCD", 8, 512, "SSD");
        Notebook SamsungS150 = new Notebook("Samsung", "S-170", "Green", 15.0, "TFT", 16, 512, "SSD");
        Notebook AsusTUF504 = new Notebook("MSI", "TTF-507", "Red", 17.0, "OLED", 32, 2048, "HDD 2.0");
        Notebook AsusTUF555 = new Notebook("Acer", "TRF-595", "Black", 14.6, "TFT", 16, 1024, "SSD");
        ...
        System.out.println("Напишите какой цвет или бренд Вас интересует: ");
